...
import com.ltd.tandung.amazon_shopping.adapter.FashionAdapter;
...
public class ThoitrangActivity extends AppCompatActivity {
    ...
    String urlGetdata = Server.Duongdansanphamfashion;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response != null && response.length() != 2) {
                    ...
                    Toast.makeText(ThoitrangActivity.this, "Đã hết dữ liệu", Toast.LENGTH_SHORT).show();
                }
    ...
    private void Anhxa() {
        ...
        adapter = new FashionAdapter(this,R.layout.custom_dong_sanpham,mangsp);
