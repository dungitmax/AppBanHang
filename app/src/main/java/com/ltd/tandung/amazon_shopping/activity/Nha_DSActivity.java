...
import com.ltd.tandung.amazon_shopping.adapter.Nha_DSAdapter;
...
public class Nha_DSActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView lv;
    ArrayList<Sanpham> mangsp;
    Nha_DSAdapter adapter;
    String urlGetdata = Server.Duongdansanphamhome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nha__ds);
        Anhxa();
        Actiontoolbar();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response != null && response.length() != 2) {
                    ...
                    Toast.makeText(Nha_DSActivity.this, "Đã hết dữ liệu", Toast.LENGTH_SHORT).show();
                }
    ...
    private void Anhxa() {
        ...
        adapter = new Nha_DSAdapter(this, R.layout.custom_dong_sanpham, mangsp);
