...
import com.ltd.tandung.amazon_shopping.adapter.Ld_SkAdapter;
...
import static com.ltd.tandung.amazon_shopping.R.id.lvLamDep;
import static com.ltd.tandung.amazon_shopping.R.id.toolbarLDSK;

public class LD_SKActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView lv;
    ArrayList<Sanpham> mangsp;
    Ld_SkAdapter adapter;
    String urlGetdata = Server.Duongdansanphambeautiful;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ld__sk);
        Anhxa();
        Actiontoolbar();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response != null && response.length() != 2) {
                    ...
                    Toast.makeText(LD_SKActivity.this, "Đã hết dữ liệu", Toast.LENGTH_SHORT).show();
                }
    ...
    private void Anhxa() {
        toolbar = (Toolbar) findViewById(toolbarLDSK);
        lv = (ListView) findViewById(lvLamDep);
        mangsp = new ArrayList<>();
        adapter = new Ld_SkAdapter(this,R.layout.custom_dong_sanpham,mangsp);
