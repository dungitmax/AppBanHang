...
import com.ltd.tandung.amazon_shopping.adapter.BookAdapter;
...
public class SachActivity extends AppCompatActivity {
    ...
    BookAdapter adapter;
    String urlGetdata = Server.Duongdansanphambook;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response != null && response.length() != 2) {
                    ...
                    Toast.makeText(SachActivity.this, "Đã hết dữ liệu", Toast.LENGTH_SHORT).show();
                }
    ...
    private void Anhxa() {
        ...
        adapter = new BookAdapter(this, R.layout.custom_dong_sanpham, mangsp);
