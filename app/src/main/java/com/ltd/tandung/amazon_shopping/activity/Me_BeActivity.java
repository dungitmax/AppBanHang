...
import com.ltd.tandung.amazon_shopping.adapter.Me_beAdapter;
...
public class Me_BeActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView lv;
    ArrayList<Sanpham> mangsp;
    Me_beAdapter adapter;
    String urlGetdata = Server.Duongdansanphammebe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_me__be);
        Anhxa();
        Actiontoolbar();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response != null && response.length() != 2) {
                    ...
                    Toast.makeText(Me_BeActivity.this, "Đã hết dữ liệu", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void Anhxa() {
        ...
        adapter = new Me_beAdapter(this, R.layout.custom_dong_sanpham, mangsp);
